...
var snowStorm = (function(window, document) {
  ...
  this.flakesMax = 1300;           // Limit total amount of snow made (falling + sticking)
  this.flakesMaxActive = 1500;      // Limit amount of snow falling at once (less = lower CPU use)
  ...
  this.flakeWidth = 500;            // Max pixel width reserved for snow element
  ...
  this.SnowFlake = function(parent,type,x,y) {
	...
	var symbls = new Array('&hearts;','&#9835;', '&#9830;', '&commat;', '&bull;');
    var schar = symbls[Math.floor(Math.random() * symbls.length)];
	
	var sclrs = new Array('#ff0000','#353535','#E8EF1F','#000000','#ffffff','#F2BF13');
